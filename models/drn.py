...
model_urls = {
    ...
    'drn26': webroot + 'drn_c_26-ddedf421.pth',
    'drn42': webroot + 'drn_c_42-9d336e8c.pth',
    'drn58': webroot + 'drn_c_58-0a53a92c.pth',
}
        ...
        if pretrained:
            if not weights_init is None:
                ...
                try:
                    ...
                    pass
                state_dict = model_zoo.load_url(model_urls[modelname], model_dir='./pretrained')
